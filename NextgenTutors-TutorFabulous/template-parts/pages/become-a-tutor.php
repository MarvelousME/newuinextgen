<?php
/**
 * Canonical page body — become-a-tutor
 * Migrated from prototypes/become-a-tutor-body.php (authoritative marketing body under former prototype-blend path).
...
<section class="section">
  <div class="wrap bt">
    ...
    <div data-reveal-x style="--rx:50px">
      ...
      <div class="bt__list">
        <div class="bt__item"><span class="bt__item-ico"><i data-lucide="wallet"></i></span><div><div class="bt__item-t">Reliable Monthly Payouts</div><div class="bt__item-d">R200â€“R350/hr depending on level &amp; format. Earnings are calculated automatically on the 1st of each month and paid by EFT.</div></div></div>
        <div class="bt__item"><span class="bt__item-ico"><i data-lucide="calendar-clock"></i></span><div><div class="bt__item-t">Total Schedule Freedom</div><div class="bt__item-d">Accept only the slots that fit your life â€” full-time or a few hours a week. Amelia syncs your calendar automatically.</div></div></div>
    ...
    <div class="calc calc--ngt-ui" data-reveal-scale>
      ...
      <div class="calc__inner calc__inner--shortcode">
        ...
        if ( shortcode_exists( 'ngt_income_calculator' ) ) {
          ...
          echo '<p class="lead">' . esc_html__( 'Income calculator unavailable â€” enable NextGen Companion UI library.', 'nextgentutors-beyondinfinity' ) . '</p>';
        }
        ?>
        <p class="calc__cta-wrap">
          <a class="btn btn--lime btn--block btn--shine" href="<?php echo esc_url( ngt_get_page_url( 'contact' ) ); ?>" data-internal><?php esc_html_e( 'Apply to Tutor â†’', 'nextgentutors-beyondinfinity' ); ?></a>
        </p>
      </div>
    </div>
  </div>
...
<section class="section" style="background:var(--slate-50)">
  <div class="wrap">
    ...
    <div class="steps">
      ...
      <article class="step icon-pop" data-reveal><span class="step__n">02</span><span class="step__ico"><i data-lucide="shield-check"></i></span><h3 class="step__title">Get Verified</h3><p class="step__desc">We confirm your SACE status, ID and police clearance â€” your safety badge unlocks bookings.</p></article>
...
<section class="section">
  <div class="wrap">
    ...
    <div class="faq" id="faq">
      ...
      <div class="faq-item"><button class="faq-q">How and when do I get paid? <span class="faq-q__ico"><i data-lucide="plus"></i></span></button><div class="faq-a"><div class="faq-a__inner">Your earnings from completed sessions are calculated automatically on the 1st of each month â€” gross session fees minus platform fees, plus any bonuses â€” and paid out by EFT. You always see your exact payout rate before accepting a booking.</div></div></div>
      <div class="faq-item"><button class="faq-q">Can I tutor part-time? <span class="faq-q__ico"><i data-lucide="plus"></i></span></button><div class="faq-a"><div class="faq-a__inner">Absolutely. You set your own availability and accept only the slots you want â€” many of our tutors teach just a few hours a week around their studies or job.</div></div></div>
    </div>
  </div>
</section>
<?php
if ( function_exists( 'bi_canonical_append_shortcodes' ) ) {
	bi_canonical_append_shortcodes( 'become-a-tutor' );
}
