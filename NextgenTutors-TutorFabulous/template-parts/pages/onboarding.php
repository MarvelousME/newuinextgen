<?php
/**
 * Canonical page body — onboarding
 * Migrated from prototypes/onboarding-body.php (authoritative marketing body under former prototype-blend path).
...
if ( function_exists( 'bi_canonical_append_shortcodes' ) ) {
	bi_canonical_append_shortcodes( 'onboarding' );
}
