<?php
/**
 * Canonical page body — find-a-tutor
 * Migrated from inc/defaults-production/find-a-tutor.php (live data / shortcodes / kinetic).
 */
/** Default â€” Find a Tutor (pages-to-review + intake form) */
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
...
<section class="ngt-section">
  <div class="ngt-container">
    <div class="ngt-section__header ngt-animate">
      ...
      <p><?php esc_html_e( 'Live directory powered by the tutor marketplace â€” ratings, subjects and availability from your database.', 'beyondinfinity' ); ?></p>
    </div>
...
<section class="ngt-section">  <div class="ngt-container bi-narrow">
    ...
    <div class="ngt-card ngt-animate bi-reassurance" style="margin-top:24px">
      <p style="margin:0"><strong><?php esc_html_e( 'Reassurance:', 'beyondinfinity' ); ?></strong> <?php esc_html_e( 'Parents pay NextGen Tutors directly. The platform manages tutor payments â€” no awkward cash handling.', 'beyondinfinity' ); ?></p>
    </div>
  </div>
</section>
...
bi_steps(
    [
        ...
        [ 'title' => __( 'Start learning', 'beyondinfinity' ), 'text' => __( 'Online whiteboard or in-person â€” your choice.', 'beyondinfinity' ) ],
    ],
