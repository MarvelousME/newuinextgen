<?php
/**
 * Canonical page body — student-dashboard
 * Migrated from inc/defaults-production/student-dashboard.php (live data / shortcodes / kinetic).
 */
/** Default theme content â€” merged from pages-to-review/dashboard.html */
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
