<?php
/**
 * Canonical page body — admin-dashboard
 * Migrated from inc/defaults-production/admin-dashboard.php (live data / shortcodes / kinetic).
 */
  ...
  <div class="ngt-container" style="max-width:1000px">
    ...
    <div class="bi-control-plane-bar ngt-animate">
      <div>
        ...
        <p style="margin:4px 0 0;opacity:.85;font-size:13px"><?php esc_html_e( 'Mission dashboard â€” workflows, bookings, CRM and platform health.', 'beyondinfinity' ); ?></p>
      </div>
