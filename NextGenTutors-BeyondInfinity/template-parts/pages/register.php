<?php
/**
 * Canonical page body — register
 * Migrated from inc/defaults-production/register.php (live data / shortcodes / kinetic).
 */
...
bi_hero( __( 'Register with NextGen Tutors', 'beyondinfinity' ), __( 'Choose the path that matches you â€” then complete a focused form.', 'beyondinfinity' ) );
?>
  ...
  <div class="ngt-container bi-register">
    <div class="bi-role-selector" role="group" aria-label="<?php esc_attr_e( 'Choose how you want to register', 'beyondinfinity' ); ?>">
      ...
      >
        ...
        <p class="bi-role-card__desc"><?php esc_html_e( 'Apply to join the vetted tutor network â€” earnings calculator included.', 'beyondinfinity' ); ?></p>
      </a>
    </div>
