<?php
/**
 * Canonical page body — login
 * Migrated from inc/defaults-production/login.php (live data / shortcodes / kinetic).
 */
/** Default theme content â€” used when no page builder content is present. */
if ( ! defined( 'ABSPATH' ) ) {
	exit;
}
...
bi_hero(
	...
	__( 'Choose how you continue â€” we route you to the right home after you sign in.', 'beyondinfinity' )
);
?>
  ...
  <div class="ngt-container bi-auth bi-narrow">
    <div class="bi-role-selector" role="group" aria-label="<?php esc_attr_e( 'Choose how you want to continue', 'beyondinfinity' ); ?>">
      ...
      >
        ...
        <h2 class="bi-role-card__title"><?php esc_html_e( 'Iâ€™m a Parent', 'beyondinfinity' ); ?></h2>
      ...
      >
        ...
        <h2 class="bi-role-card__title"><?php esc_html_e( 'Iâ€™m a Student 18+', 'beyondinfinity' ); ?></h2>
      ...
      >
        ...
        <h2 class="bi-role-card__title"><?php esc_html_e( 'Iâ€™m a Tutor', 'beyondinfinity' ); ?></h2>
    ...
    <?php else : ?>
      <div class="ngt-card ngt-animate bi-register__panel bi-login__panel" aria-labelledby="bi-login-role-<?php echo esc_attr( $role ); ?>">
        ...
        <?php if ( $login_failed ) : ?>
          <div class="ngc-form-error-summary bi-login__error" role="alert" tabindex="-1">
            <p class="ngc-form-error-summary__title"><?php esc_html_e( 'Sign-in didnâ€™t work', 'beyondinfinity' ); ?></p>
            <ul>
              <li><?php esc_html_e( 'Check your email/username and password, then try again.', 'beyondinfinity' ); ?></li>
              <li><?php esc_html_e( 'Caps Lock can change your password â€” toggle it off if needed.', 'beyondinfinity' ); ?></li>
              <li><a href="#bi-login-forgot"><?php esc_html_e( 'Reset your password', 'beyondinfinity' ); ?></a> <?php esc_html_e( 'if youâ€™ve forgotten it â€” reset emails usually arrive within a few minutes.', 'beyondinfinity' ); ?></li>
            </ul>
          </div>
        <?php endif; ?>
      ...
      <div id="bi-login-forgot" class="ngt-card bi-surface-card ngt-animate bi-login__forgot">
        ...
        <p class="bi-login__forgot-lead"><?php esc_html_e( 'Request a reset link. Expect the email within a few minutes â€” check spam if it hasnâ€™t arrived after 10 minutes.', 'beyondinfinity' ); ?></p>
