...
**Stack versions:** Theme `BI_VERSION` **2.0.0** · Companion `NGC_VERSION` **1.9.19**
...
| Theme / presentation | [theme.md](theme.md) | BeyondInfinity edit root, UI Library, Elementor |
...
| Audience | Start |
|----------|-------|
| New developer | [../SYSTEM-OVERVIEW.md](../SYSTEM-OVERVIEW.md) → [platform.md](platform.md) → [companion-domain.md](companion-domain.md) |
