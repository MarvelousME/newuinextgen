<?php
/**
 * Canonical page body — thank-you
 * Migrated from inc/defaults-production/thank-you.php (live data / shortcodes / kinetic).
 */
...
$messages = [
  ...
  'parent'  => __( 'Thank you for your tutor request. We are reviewing your learnerâ€™s needs and will suggest suitable matches shortly.', 'beyondinfinity' ),
...
$timelines = [
  ...
  'parent' => [
    [ 'title' => __( 'Request received', 'beyondinfinity' ), 'text' => __( 'We capture your learnerâ€™s subject and schedule needs.', 'beyondinfinity' ) ],
  ...
  'general' => [
    ...
    [ 'title' => __( 'Lessons begin', 'beyondinfinity' ), 'text' => __( 'Online, in-person, or hybrid â€” your choice.', 'beyondinfinity' ) ],
  ],
];
...
<section class="ngt-section">
  <div class="ngt-container">
    <div class="ngt-card bi-thankyou ngt-animate">
      <div class="bi-thankyou__icon" aria-hidden="true">âœ“</div>
