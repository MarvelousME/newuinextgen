...
(function () {
  ...
  function injectCss() {
    ...
    if (document.querySelector('link[href="assets/css/floating.css"]')) return;
    const link = document.createElement("link");
    link.rel = "stylesheet"; link.href = "assets/css/floating.css";
  ...
  function buildDock() {
    ...
    dock.className = "float-dock"; dock.id = "float-dock";
    dock.innerHTML = `
      <button class="fdock-btn fdock-btn--top" id="back-to-top" aria-label="Back to top" title="Back to top">
      ...
      <button class="fdock-btn fdock-btn--match has-pulse" id="match-dock-btn" aria-label="Find a tutor match" title="Match Tutor">
      ...
      <button class="fdock-btn fdock-btn--support" id="support-dock-btn" aria-label="Support" title="Support Centre">
      ...
      <button class="fdock-btn fdock-btn--livechat has-unread" id="chat-dock-btn" aria-label="Live Chat" title="Live Chat">
      ...
      <a class="fdock-btn fdock-btn--wa" href="https://wa.me/27123456789?text=Hi%20NextGen%20Tutors%2C%20I%20need%20help" target="_blank" rel="noopener" aria-label="WhatsApp" title="WhatsApp">
  ...
  function buildSupportPanel() {
    ...
    el.className = "support-panel"; el.id = "support-panel";
    el.innerHTML = `
      <div class="support-panel__head">
        <div>
          <div class="support-panel__title">Support Centre</div>
          <div class="support-panel__sub">How can we help you today?</div>
        </div>
        <button class="chat-icon-btn chat-icon-btn--close" id="support-close" aria-label="Close">
      ...
      <div class="support-panel__body" id="sp-actions-view">
        <button class="support-action" id="sp-ticket-btn">
          ...
          <div>
            ...
            <div class="support-action__desc">Submit a request — we respond within 2 hours</div>
          </div>
        ...
        <button class="support-action" id="sp-chat-btn">
          <div class="support-action__ico" style="background:rgba(174,206,97,.18);color:var(--lime-deep)">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
            <span style="position:absolute;top:5px;right:5px;width:8px;height:8px;border-radius:50%;background:#22c55e;border:1.5px solid #fff"></span>
          </div>
          <div>
            <div class="support-action__title">Talk to an Agent</div>
            <div class="support-action__desc">Live chat — agent available now</div>
          </div>
          <div style="background:var(--lime-soft);color:var(--navy);font-size:9px;font-weight:900;text-transform:uppercase;letter-spacing:.06em;padding:3px 9px;border-radius:var(--r-pill);white-space:nowrap">Online</div>
        </button>

        <div class="support-action-divider"></div>

        <a class="support-action" href="support.html" data-internal>
          <div class="support-action__ico" style="background:var(--slate-100);color:var(--slate-600)">
          ...
          <div>
            <div class="support-action__title">Support Centre</div>
            <div class="support-action__desc">Browse FAQs, guides &amp; help articles</div>
          </div>
          <div class="support-action__end"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><path d="M9 18l6-6-6-6"/></svg></div>
        </a>
      </div>
      ...
      <div class="sp-form-wrap" id="sp-form-view">
        <div class="sp-form-head">
          <button class="sp-form-head__back" id="sp-back-btn" aria-label="Back">
        ...
        <div id="sp-form-fields">
          ...
          <button class="btn btn--primary btn--block" id="sp-submit" style="padding:12px 18px;font-size:12px;margin-top:4px">
        ...
        <div class="sp-success" id="sp-success">
          ...
          <div class="sp-success__d">We'll respond within 2 business hours.<br/>Check <strong>support@nextgentutors.co.za</strong> for updates.</div>
        </div>
      </div>

      <div class="support-panel__foot">
        <a class="support-panel__foot-link" href="support.html" data-internal>
  ...
  function initSupportPanel() {
    ...
    submitBtn && submitBtn.addEventListener("click", () => {
      ...
      if (!subjectEl || !subjectEl.value.trim()) {
        if (subjectEl) { subjectEl.focus(); subjectEl.style.borderColor = "#ef4444"; }
        return;
      }
  ...
  function boot() {
    ...
    const ready = () => { initBackToTop(); initChatTrigger(); initSupportPanel(); };
