...
class NGT3D_Asset_Loader {
	...
	public static function enqueue(): void {
		...
		wp_enqueue_script(
			'ngt3d-plugin-manager',
			NGT3D_PLUGIN_URL . 'assets/js/ngt-3d-plugin-manager.js',
			[ 'ngt3d-compat' ],
			NGT3D_VERSION,
			true
		);
		$runtime_deps[] = 'ngt3d-plugin-manager';

		wp_enqueue_script(
			'ngt3d-transform-composer',
			NGT3D_PLUGIN_URL . 'assets/js/ngt-3d-transform-composer.js',
			[ 'ngt3d-plugin-manager' ],
			NGT3D_VERSION,
			true
		);
		$runtime_deps[] = 'ngt3d-transform-composer';

		wp_enqueue_script(
			'ngt3d-motion-primitives',
			NGT3D_PLUGIN_URL . 'assets/js/ngt-3d-motion-primitives.js',
			[ 'ngt3d-transform-composer' ],
			NGT3D_VERSION,
			true
		);
